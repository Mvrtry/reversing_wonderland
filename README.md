...
1. קריאה ראשונה שמובילה לפונקציה של פעולת הדפסה (ה-`printf` של התוכנית שמבקש את הקלט). 
   ![הקפיצה לפונקציית ההדפסה](screenshots/intro_call_external.png)
   וכשצוללים לתוך הפונקציה הזו, רואים בבירור את פקודת ההדפסה למערכת ההפעלה:
   ![פונקציית ההדפסה מבפנים](screenshots/intro_printf_inside.png)

2. קריאה שנייה שלוקחת אותנו אל ה''קייס מאסטר'' – הפונקציה שאחראית לקחת את מספר השלב שהוזן ולפצל את התוכנית למקרים, כאשר כל מקרה מוביל לשלב אחר באתגר.
